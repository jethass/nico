...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'clubconnectionhistory.export_service' => 'getClubconnectionhistory_ExportServiceService',
            'coachingquiz.export_service' => 'getCoachingquiz_ExportServiceService',
            'coachingsummary.export_service' => 'getCoachingsummary_ExportServiceService',
            ...
            'janrain_crm_exchange_service' => 'getJanrainCrmExchangeServiceService',
            ...
            'mobileconnectionhistory.export_service' => 'getMobileconnectionhistory_ExportServiceService',
            ...
            'nicorette.calendar_service' => 'getNicorette_CalendarServiceService',
            'nicorette.csv.import' => 'getNicorette_Csv_ImportService',
            'nicorette.detect.mobile' => 'getNicorette_Detect_MobileService',
            'nicorette.diary_service' => 'getNicorette_DiaryServiceService',
            'nicorette.economy_service' => 'getNicorette_EconomyServiceService',
            'nicorette.export_service' => 'getNicorette_ExportServiceService',
            'nicorette.plan_service' => 'getNicorette_PlanServiceService',
            'nicorette.session' => 'getNicorette_SessionService',
            'nicorette.statistic_service' => 'getNicorette_StatisticServiceService',
            'nicorette.tools' => 'getNicorette_ToolsService',
            'nicorette.zut_tools' => 'getNicorette_ZutToolsService',
            ...
            'user_tools_service' => 'getUserToolsServiceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/bemobee_nicorette/trunk/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/bemobee_nicorette/trunk/app/Resources');
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    protected function getClubconnectionhistory_ExportServiceService()
    {
        return $this->services['clubconnectionhistory.export_service'] = new \Nicorette\CentralBundle\Services\ClubConnectionHistory($this, $this->get('nicorette.export_service'));
    }
    protected function getCoachingquiz_ExportServiceService()
    {
        return $this->services['coachingquiz.export_service'] = new \Nicorette\CentralBundle\Services\CoachingQuiz($this, $this->get('nicorette.export_service'));
    }
    protected function getCoachingsummary_ExportServiceService()
    {
        return $this->services['coachingsummary.export_service'] = new \Nicorette\CentralBundle\Services\CoachingSummary($this, $this->get('nicorette.export_service'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(new \Nicorette\CentralBundle\Listener\PatientListener($this));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'nicorette', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Nicorette\\CentralBundle\\Entity'))), 'Nicorette\\CentralBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('NicoretteCentralBundle' => 'Nicorette\\CentralBundle\\Entity'));
        ...
        $b->setProxyDir('C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_873ad924c973ed0bacaec89a2cfa0e0015bfb9d1be3da769745dcca3721c73f2');
        return $instance;
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/bemobee_nicorette/trunk/app/Resources');
    }
    ...
    protected function getJanrainCrmExchangeServiceService()
    {
        return $this->services['janrain_crm_exchange_service'] = new \Nicorette\CentralBundle\Services\JanrainCrmExchangeService($this);
    }
    ...
    protected function getMobileconnectionhistory_ExportServiceService()
    {
        return $this->services['mobileconnectionhistory.export_service'] = new \Nicorette\CentralBundle\Services\MobileConnectionHistory($this, $this->get('nicorette.export_service'));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/bemobee_nicorette/trunk/app/logs/prod.log', 100, true);
    }
    ...
    protected function getNelmioApiDoc_Formatter_HtmlFormatterService()
    {
        ...
        $instance->setApiName('Nicorette API');
    ...
    protected function getNicorette_CalendarServiceService()
    {
        return $this->services['nicorette.calendar_service'] = new \Nicorette\CentralBundle\Services\CalendarService($this);
    }
    protected function getNicorette_Csv_ImportService()
    {
        return $this->services['nicorette.csv.import'] = new \Nicorette\CentralBundle\Services\ImportCsvService($this);
    }
    protected function getNicorette_Detect_MobileService()
    {
        return $this->services['nicorette.detect.mobile'] = new \Nicorette\CentralBundle\Services\DetectMobileService();
    }
    protected function getNicorette_DiaryServiceService()
    {
        return $this->services['nicorette.diary_service'] = new \Nicorette\CentralBundle\Services\MyDiaryService($this);
    }
    protected function getNicorette_EconomyServiceService()
    {
        return $this->services['nicorette.economy_service'] = new \Nicorette\CentralBundle\Services\EconomyService($this);
    }
    protected function getNicorette_ExportServiceService()
    {
        return $this->services['nicorette.export_service'] = new \Nicorette\CentralBundle\Services\ExportService($this);
    }
    protected function getNicorette_PlanServiceService()
    {
        return $this->services['nicorette.plan_service'] = new \Nicorette\CentralBundle\Services\ActionPlanService($this);
    }
    protected function getNicorette_SessionService()
    {
        return $this->services['nicorette.session'] = new \Nicorette\CentralBundle\Services\SessionService($this->get('session.storage.native'), $this->get('session.attribute_bag'), $this->get('session.flash_bag'), $this->get('doctrine.orm.default_entity_manager'), $this->get('nicorette.tools'));
    }
    protected function getNicorette_StatisticServiceService()
    {
        return $this->services['nicorette.statistic_service'] = new \Nicorette\CentralBundle\Services\StatisticService($this);
    }
    protected function getNicorette_ToolsService()
    {
        return $this->services['nicorette.tools'] = new \Nicorette\CentralBundle\Services\ToolsService($this);
    }
    protected function getNicorette_ZutToolsService()
    {
        return $this->services['nicorette.zut_tools'] = new \Nicorette\CentralBundle\Services\ZutService($this);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session'] = new \Symfony\Component\HttpFoundation\Session\Session($this->get('session.storage.native'), $this->get('session.attribute_bag'), $this->get('session.flash_bag'));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/bemobee_nicorette/trunk/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/bemobee_nicorette/trunk/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:/wamp/www/bemobee_nicorette/trunk/app/Resources/TwigBundle/views', 'Twig');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Nicorette\\ApiBundle/Resources/views'), 'NicoretteApi');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Nicorette\\CentralBundle/Resources/views'), 'NicoretteCentral');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Nicorette\\FrontBundle/Resources/views'), 'NicoretteFront');
        ...
        $instance->addPath('C:/wamp/www/bemobee_nicorette/trunk/app/Resources/views');
    ...
    protected function getUserToolsServiceService()
    {
        return $this->services['user_tools_service'] = new \Nicorette\CentralBundle\Services\UserToolsService($this);
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/bemobee_nicorette/trunk/app/../web', false);
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/jms_serializer'));
        return $instance;
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54dc87f36354c')), true);
    ...
    {
        return $this->services['session.attribute_bag'] = new \Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag();
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod',
            'kernel.logs_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/logs',
            'kernel.bundles' => array(
                ...
                'NicoretteApiBundle' => 'Nicorette\\ApiBundle\\NicoretteApiBundle',
                'NicoretteCentralBundle' => 'Nicorette\\CentralBundle\\NicoretteCentralBundle',
                'NicoretteFrontBundle' => 'Nicorette\\FrontBundle\\NicoretteFrontBundle',
            ...
            'rep_export' => 'C:/wamp/www/bemobee_nicorette/trunk/app/../web/export',
            'mobileconnectionhistory' => array(
                'JanrainId' => 'getJanrainId',
                'JaccomplisLastConnectionDate' => 'getJaccomplisLastConnectionDate',
            ),
            'clubconnectionhistory' => array(
                'JanrainId' => 'getJanrainId',
                'ClubLastConnectionDate' => 'getClubLastConnectionDate',
                'ForumLastConnectionDate' => 'getForumLastConnectionDate',
            ),
            'coachingsummary' => array(
                'JanrainId' => 'getJanrainId',
                'PointBalance' => 'getPointBalance',
                'LastFailedDate' => 'getLastFailedDate',
                'LastTemptationDate' => 'getLastTemptationDate',
                'NbFailed' => 'getNbFailed',
                'NbTemptation' => 'getNbTemptation',
                'NbOfCigarettesBeforeProgram' => 'getNbOfCigarettesBeforeProgram',
                'PacketPrice' => 'getPacketPrice',
                'RegisterDate' => 'getRegisterDate',
            ),
            'coachingquiz' => array(
                'JanrainId' => 'getJanrainId',
                'QuizDate' => 'getQuizDate',
                'EstimatedStopDelay' => 'getEstimatedStopDelay',
                'SmokingReason' => 'getSmokingReason',
                'StopObstacle' => 'getStopObstacle',
                'StopReason' => 'getStopReason',
                'HasAlreadyTried' => 'getHasAlreadyTried',
                'FirstPeriodCigarette' => 'getFirstPeriodCigarette',
                'CigaretMostDiffcultAbort' => 'getCigaretMostDiffcultAbort',
                'KnowHow' => 'getKnowHow',
            ),
            'estimatedstopdelay' => array(
                0 => 1,
                1 => 2,
                2 => 4,
                3 => 5,
            ...
            'hasalreadytried' => array(
                1 => 34,
                2 => 35,
                3 => 36,
                4 => 37,
            ),
            'firstperiodcigarette' => array(
                1 => 38,
                2 => 39,
                3 => 40,
                4 => 41,
            ),
            'cigaretmostdiffcultabort' => array(
                1 => 48,
                2 => 49,
            ),
            'knowhow' => array(
            ...
            'feedback_1' => array(
                'profil' => array(
                    'text1' => 'Vous avez le sentiment que fumer peut vous aider à résoudre des problèmes du quotidien, certaines cigarettes représentent une forme de béquille psychologique : elles vous aident à juguler vos émotions, comme la colère, l’impatience, la surprise ou la déception. La cigarette constitue un élément important de votre personnalité.',
                    'text2' => 'Vous avez le sentiment que fumer peut vous aider à résoudre des problèmes du quotidien, certaines cigarettes représentent une forme de béquille psychologique : elles vous aident à juguler vos émotions, comme la colère, l’impatience, la surprise ou la déception. Mais la cigarette n’occupe pas pour autant une place importante dans votre personnalité.',
                    'text3' => 'Contrairement à d’autres fumeurs, vous ne considérez pas la cigarette comme une béquille psychologique qui vous aide à juguler certaines émotions (colère, impatience, surprise, déception...). Le fait de fumer constitue néanmoins un élément important de votre personnalité.',
                    'text4' => 'Contrairement à d’autres fumeurs, vous n’accordez pas à la cigarette le rôle d’une « béquille psychologique » qui vous aiderait à juguler certaines émotions (colère, impatience, surprise, déception...), de même que vous semblez n’éprouver aucun plaisir à vous identifier comme un fumeur. Vous subissez votre addiction tabagique.',
                ),
            ),
            'feedback_2' => array(
                'profil' => array(
                    'text1' => 'Vous avez l’habitude de fumer à des moments bien précis (parfois sans même en ressentir le besoin), la gestuelle associée à la cigarette semble beaucoup compter pour vous et vous associez la cigarette à des moments de détente, de plaisir et de récompense. Vous avez le sentiment que le tabac provoque chez vous une satisfaction immédiate et soulage rapidement des tensions désagréables.',
                    'text2' => 'Vous avez l’habitude de fumer à des moments bien précis (parfois sans même en ressentir le besoin) et la gestuelle du fumeur semble beaucoup compter pour vous, mais vous n’associez pas forcément la cigarette à des moments de détente, de plaisir ou de récompense. ',
                    'text3' => 'Vous n’avez pas acquis d’habitudes ancrées avec la cigarette. Vous préférez associer vos pauses cigarettes à des moments de détente, de plaisir ou de récompense. Vous avez le sentiment que le tabac provoque chez vous une satisfaction immédiate et soulage rapidement des tensions désagréables.',
                    'text4' => 'Vous n’avez pas acquis d’habitudes ancrées avec la cigarette et vous n’associez pas le fait de fumer à des moments de détente, de plaisir ou même de récompense.',
                ),
                'profil_2' => array(
                    'text1' => 'La cigarette fait partie de votre vie sociale et du personnage que vous souhaitez montrer en société',
                    'text2' => 'La cigarette ne joue pas un rôle important dans votre vie sociale, vous ne ressentez pas spécialement le besoin de fumer davantage quand vous êtes en société.',
                ),
                'motivation' => array(
                    'text1' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent votre santé et votre volonté de faire des économies d’argent. Effectivement, en cessant de fumer vous allez d’abord retrouver votre souffle, vous serez moins fatigué, et le risque de cancer ou de maladies cardiovasculaire diminuera d’année en année. Sans parler des économies d’argent que vous ferez et qui seront visibles dès le premier mois.',
                    'text2' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent votre santé et le désir d’en finir avec une addiction qui a des conséquences sur votre vie sociale. Effectivement, en cessant de fumer vous allez d’abord retrouver votre souffle, vous serez moins fatigué, et le risque de cancer ou de maladies cardiovasculaire diminuera d’année en année. Par ailleurs, vous ne dérangerez plus les non-fumeurs autour de vous. Sans parler des économies d’argent que vous ferrez et qui seront visibles dès le premier mois.',
                    'text3' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent votre santé et votre amour-propre (vous souhaitez mieux contrôler votre vie). Effectivement, en cessant de fumer vous allez d’abord retrouver votre souffle, vous serez moins fatigué, et le risque de cancer ou de maladies cardiovasculaire diminuera d’année en année. Par ailleurs, en réussissant à vous libérer de la dépendance, vous aurez une meilleure estime de vous. Sans parler des économies d’argent que vous ferez et qui seront visibles dès le premier mois.',
                    'text4' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent votre volonté de faire des économies d’argent et le désir d’en finir avec une addiction qui a des conséquences sur votre vie sociale. Effectivement, vous ne dérangerez plus les non-fumeurs autour de vous et vous vous déplacerez plus librement sans avoir à penser à vos provisions de cigarettes ou aux espaces fumeurs. Votre santé va s’améliorer rapidement. Vous allez retrouver votre souffle, vous serez moins fatigué, et le risque de cancer ou de maladies cardiovasculaire diminuera d’année en année. Sans parler des économies d’argent que vous ferez et qui seront visibles dès le premier mois.',
                    'text5' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent votre volonté de faire des économies d’argent et votre amour propre. Effectivement, en réussissant à vous libérer de la dépendance, vous aurez une meilleure estime de vous. Sans parler des économies d’argent que vous ferez et qui seront visibles dès le premier mois, ou de votre santé qui s’améliorera.',
                    'text6' => 'Les motivations que vous avez exprimées pour vous libérer du tabac concernent le désir d’en finir avec une addiction qui a des conséquences sur votre vie sociale et votre amour-propre (vous souhaitez mieux contrôler votre vie). Effectivement, vous ne dérangerez plus les non-fumeurs autour de vous et vous vous déplacerez plus librement sans avoir à penser à vos provisions de cigarettes ou aux espaces fumeurs. Par ailleurs, en réussissant à vous libérer de la dépendance, vous aurez une meilleure estime de vous. Sans parler de votre santé qui s’améliorera progressivement et des économies d’argent que vous ferez et qui seront visibles dès le premier mois.',
                    'text7' => 'Vous souhaitez arrêter de fumer pour plusieurs raisons. Vous avez compris que vous avez tout à gagner à arrêter la cigarette, pour votre santé, votre vie sociale, votre amour propre et… votre porte-monnaie !',
                ),
            ),
            'feedback_3' => array(
                'profil' => array(
                    'text1' => 'Votre dépendance physique à la nicotine est importante, mais les substituts nicotiniques proposés par Nicorette vous aideront à vaincre cette dépendance. Ce qui nous permettra de nous focaliser sur l’aspect psychologique de votre addiction au tabac.',
                    'text2' => 'Bonne nouvelle, votre dépendance à la nicotine est relativement faible.  Cela ne veut pas forcément dire que votre sevrage sera facile, car il faut également considérer l\'aspect psychologique de votre addiction. Pour pouvoir vous focaliser sur cet aspect psychologique du sevrage, Nicorette peut vous conseiller des substituts nicotiniques adaptés à votre profil.',
                ),
            ),
            'contract2' => array(
                0 => 6,
            ...
            'first_question_my_diary_after_id' => 22,
            'second_question_my_diary_after_id' => 23,
            'first_question_my_diary_before_id' => 20,
            'second_question_my_diary_before_id' => 21,
            'other_room_mate_smoke_question_id' => 14,
            'estimated_stop_delay_question_id' => 1,
            'smoking_reason_question_id' => 2,
            'stop_obstacle_question_id' => 3,
            'stop_reason_question_id' => 4,
            'has_already_tried_question_id' => 5,
            'first_period_cigarette_question_id' => 7,
            'cigarette_most_difficult_abort_question_id' => 10,
            'know_how_question_id' => 19,
            'room_mate_smoke_yes_choice' => 60,
            'third_question_zut_i_cracked_id' => 44,
            'seventh_question_feedback_2' => 13,
            'text_field_nb_cigarette_id' => 44,
            'known_by_doctor_ids' => array(
                0 => 66,
                1 => 67,
            ),
            'quit_smoking_ids' => array(
                0 => 6,
                1 => 7,
            ),
            'first_question_feedback_1' => 1,
            'want_quit_smoking_now_id' => 5,
            'my_diary_before_quit_code' => 'MYDIARY_BEFOREQUIT',
            'my_diary_after_quit_code' => 'MYDIARY_AFTERQUIT',
            'panic_button_want_code' => 'PANIC_BUTTON_WANT',
            'panic_button_cracked_code' => 'PANIC_BUTTON_CRACKED',
            'panic_button_not_cracked_code' => 'PANIC_BUTTON_TEMPTED_NOT_CRACKED',
            'feedback_3_quiz_code' => 'FEEDBACK_3',
            'feedback_2_quiz_code' => 'FEEDBACK_2',
            'feedback_1_quiz_code' => 'FEEDBACK_1',
            'action_plan_code' => 'ACTION_PLAN',
            'quit_program_code' => 'EXIT',
            'nicotinic_product_code' => 'NICOTINIC_PRODUCT',
            'first_question_nicotinic_product_id' => 44,
            'reduction_percentage' => 0.20000000000000001,
            'product_for_answer_fager_gt_5' => array(
                54 => 'Patch',
                55 => 'Inhaleur',
                56 => 'Gommes',
                57 => 'Tab',
            ...
            'product_for_answer_fager_lt_5' => array(
                54 => 'Patch',
                55 => 'Inhaleur',
                56 => 'Gommes',
                57 => 'Tab',
            ...
            'question_id_for_quit_date_sup_forteen_days' => array(
                0 => 38,
                1 => 39,
                2 => 40,
                3 => 41,
            ),
            'question_id_for_quit_date_sup_seven_days' => array(
                0 => 39,
                1 => 40,
                2 => 41,
            ),
            'question_id_for_quit_date_sup_one_day' => array(
                0 => 40,
                1 => 41,
            ),
            'question_id_for_quit_date_equal_current_day' => array(
                0 => 41,
            ),
            'question_id_for_quit_date_immediate' => array(
                0 => 42,
            ),
            'question_id_for_quit_date_passed' => array(
                0 => 43,
            ),
            'points' => array(
                'patient_create' => 50,
            ...
            'sur_une_echelle_de_1_a_10_comment_evaluez' => 22,
            'avez_vous_atteint_votre_objectif_de_reduction' => 20,
            'a_quel_moment_avez_vous_craque' => 31,
            'quel_a_ete_le_declenchement_de_votre_envie' => 25,
            'combien_de_cigarettes_fumez_vous_par_jour' => 9,
            'avez_vous_pris_un_substitut_nicotinique' => 23,
            'amount_cigarette' => 7,
            'packet_cigarette' => 20,
            'janrain_params' => array(
                'client_secret' => '72m3bpf8qap8yawk5wtxb6nd2y69b4sa',
                'client_id' => '9fb82h2ajzwg9w9t4zbejd89kzxpd5j4',
                'type_name' => 'CON_EMEA_FR_Nicorette',
            ),
            'janrain_uri' => 'https://jj.eu-dev.janraincapture.com/entity',
            'crm_url' => 'https://jnj-nicorette-services-rec.cirrus-cloud.net/api/persons',
            'verification_code_url' => 'https://jj.eu-dev.janraincapture.com/access/getVerificationCode?',
            'authorization_code_url' => 'https://jj.eu-dev.janraincapture.com/access/getAuthorizationCode?',
            'oauth_token_url' => 'https://jj.eu-dev.janraincapture.com/oauth/token?',
            'find_entity_code_url' => 'https://jj.eu-dev.janraincapture.com/entity.find',
            'update_entity_url' => 'https://jj.eu-dev.janraincapture.com/entity.update',
            'find_entity_url' => 'https://jj.eu-dev.janraincapture.com/entity',
            'confirmation_url' => 'https://jnj-nicorette-services-rec.cirrus-cloud.net/api/persons/confirm',
            'forgot_url' => 'https://jnj-nicorette-services-rec.cirrus-cloud.net/api/persons/renewal',
            'base_url' => 'http://nicorette.proxym-it.net',
            'for_client_id' => 'sutmyda5wmwf43fxgcs5u3chg956wjp6',
            'back_janrain_params' => array(
                'client_secret' => 'marcy5kwym87ttde4g9bmuytn6vw9gtj',
                'client_id' => 'jzwegw67qwudabbu96egxxjmmdxxvvtb',
            ),
            ...
            'session.save_path' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/wamp/www/bemobee_nicorette/trunk/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/bemobee_nicorette/trunk/app/../web',
            'assetic.write_to' => 'C:/wamp/www/bemobee_nicorette/trunk/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => 'C:/wamp/www/bemobee_nicorette/trunk/app/cache/prod/fos_rest',
            ...
            'nelmio_api_doc.api_name' => 'Nicorette API',
