 ...
 */
class cities extends \Nicorette\CentralBundle\Entity\cities implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Nicorette\\CentralBundle\\Entity\\cities' . "\0" . 'country', '' . "\0" . 'Nicorette\\CentralBundle\\Entity\\cities' . "\0" . 'zip', '' . "\0" . 'Nicorette\\CentralBundle\\Entity\\cities' . "\0" . 'name', '' . "\0" . 'Nicorette\\CentralBundle\\Entity\\cities' . "\0" . 'latitude', '' . "\0" . 'Nicorette\\CentralBundle\\Entity\\cities' . "\0" . 'longitude');
        }
