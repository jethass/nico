 ...
 */
class PointHistory extends \Nicorette\CentralBundle\Entity\PointHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'nbPoint', 'createdAt', 'updatedAt', 'patient');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PointHistory $proxy) {
    ...
    public function setNbPoint($nbPoint)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbPoint', array($nbPoint));
    ...
    public function getNbPoint()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbPoint', array());
