 ...
 */
class Contact extends \Nicorette\CentralBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'email', 'phone', 'patient');
        }
    ...
    public function setData($request)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setData', array($request));

        return parent::setData($request);
    }
