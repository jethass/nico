 ...
 */
class QuizAnswer extends \Nicorette\CentralBundle\Entity\QuizAnswer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'createdAt', 'updatedAt', 'patient', 'quiz', 'answers');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QuizAnswer $proxy) {
    ...
    public function setData($quiz, $user)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setData', array($quiz, $user));

        return parent::setData($quiz, $user);
    }
